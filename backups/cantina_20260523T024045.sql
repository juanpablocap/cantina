...
\restrict HVM1GWT0cryHmlOpkpCXC8KRr2MqPVQKQWhEQCVHHfN5avO89EyBX4YM3nzHNPy
...
2	Hamburguesa completa	7000	3	5	\N	t	t	1
6	Pizza muzzarella	7500	4	3	\N	t	t	1
10	Cerveza Quilmes	2500	17	8	\N	t	t	2
...
SELECT pg_catalog.setval('public."CarouselImage_id_seq"', 5, true);
...
SELECT pg_catalog.setval('public."PedidoItem_id_seq"', 140, true);
...
SELECT pg_catalog.setval('public."Pedido_id_seq"', 57, true);
...
\unrestrict HVM1GWT0cryHmlOpkpCXC8KRr2MqPVQKQWhEQCVHHfN5avO89EyBX4YM3nzHNPy
